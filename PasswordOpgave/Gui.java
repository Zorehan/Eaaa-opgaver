	...
	public void ButtonClicked(ActionEvent e) {
		if (e.getSource() == btnLogin) {
			for (User user : userModel.getObservableUsers()){
				if(brugernavn.getText().equals(user.getUsername()) &&
				encryption.checkPassword(password.getText(), user.getPassword()))
				{
					lblInfoBruger.setText(user.getPassword());
			...
			User user = new User(brugernavn.getText(), encryption.encryptPassword(password.getText()));
